package com.fox.recordh264.file;
...
public class H264ReadRunable implements Runnable {
    ...
    public H264ReadRunable(String filePath)
    {
        h264FilePath=filePath;
    }
    ...
    public void run() {
        try {
            Log.d(TAG, "run: " + h264FilePath);
            mInputStream = new DataInputStream(new FileInputStream(h264FilePath));
