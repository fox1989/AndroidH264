...
import com.fox.recordh264.encode.AACEncoder;
 ...
 * 邮箱：chezi008@qq.com
 */
public class MuxerMp4Activity extends Activity {
    ...
    private void initVideoCodec(SurfaceTexture surface) {
        mVideoDecode = new H264Decoder(this,1920,1080);
