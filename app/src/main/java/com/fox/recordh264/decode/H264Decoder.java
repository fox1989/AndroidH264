package com.fox.recordh264.decode;
...
import com.fox.recordh264.utils.SPUtils;
...
//    private int mTrackIndex;
    ...
    public H264Decoder(Context context,int width,int height) {
    ...
    public void initCodec() {
        ...
        if (UseSPSandPPS) {
            ...
            //读取之前保存的sps 和pps
            byte[] header_sps = (byte[]) spUtils.readObject(mContext, VIDEO_KEY_SPS);
            byte[] header_pps = (byte[]) spUtils.readObject(mContext, VIDEO_KEY_PPS);
